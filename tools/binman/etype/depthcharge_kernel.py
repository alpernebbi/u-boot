...
class Entry_depthcharge_kernel(Entry_section):
    ...
    def BuildSectionData(self, required):
        ...
        tools.WriteFile(vmlinuz_fname, vmlinuz)
        tools.WriteFile(config_fname, config)
        tools.WriteFile(bootloader_fname, bootloader)

        output_fname = tools.GetOutputFilename('%s.kpart' % uniq)
        prefix = tools.GetInputFilename(self.keydir) + '/'
