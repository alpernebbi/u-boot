...
'  fdtmap             90   243  fdtmap          90',
    ...
    def testFitSplitElfBadDirective(self):
        ...
        err = self._check_bad_fit('224_fit_bad_dir.dts')
        self.assertIn(
    ...
    def testFitSplitElfBadDirectiveConfig(self):
        ...
        err = self._check_bad_fit('225_fit_bad_dir_config.dts')
        self.assertEqual(
    ...
    def testDepthchargeKernel(self):
        ...
        data = self._DoReadFileDtb(
            '226_depthcharge_kernel.dts', entry_args=entry_args)[0]
        expected = (
            VBLOCK_DATA +
