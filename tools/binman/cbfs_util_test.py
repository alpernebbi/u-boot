...
class TestCbfs(unittest.TestCase):
    ...
    def _check_uboot(self, cbfs, ftype=cbfs_util.TYPE_RAW, offset=0x30,
    ...
    def _check_dtb(self, cbfs, offset=0x34, data=U_BOOT_DTB_DATA,
                   cbfs_offset=None):
    ...
    def test_cbfs_missing_attribute(self):
        ...
        tag_pos = pos + cbfs_util.FILE_HEADER_LEN
        tag_pos += tools.align(len('u-boot') + 1, cbfs_util.ATTRIBUTE_ALIGN)
    ...
    def test_cbfs_raw_compress(self):
        ...
        self.assertEqual(cfile.offset, 48)
        ...
        self.assertEqual(cfile.offset, 52)
        self.assertEqual(cfile.data, COMPRESS_DATA)
        self.assertEqual(cfile.ftype, cbfs_util.TYPE_RAW)
    ...
    def test_cbfs_check_offset(self):
        ...
        cbfs = cbfs_util.CbfsReader(data)
        self.assertEqual(0x30, cbfs.files['u-boot'].cbfs_offset)
        self.assertEqual(0x74, cbfs.files['u-boot-dtb'].cbfs_offset)
